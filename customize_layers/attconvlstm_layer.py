...
class AttConvRNN2D(RNN):
    ...
    def __init__(self,
        ...
        super(AttConvRNN2D, self).__init__(cell,
                                           return_sequences,
                                           return_state,
                                           go_backwards,
                                           stateful,
    ...
    def __call__(self, inputs, initial_state=None, constants=None, **kwargs):
        ...
        if initial_state is None and constants is None:
            return super(AttConvRNN2D, self).__call__(inputs, **kwargs)
        ...
        if K.is_keras_tensor(additional_inputs[0]):
            ...
            output = super(AttConvRNN2D, self).__call__(full_input, **kwargs)
...
class AttConvLSTM2DCell(DropoutRNNCellMixin, Layer):
    ...
    def __init__(self,
                 ...
                 recurrent_dropout=0.,
                 **kwargs):
        super(AttConvLSTM2DCell, self).__init__(**kwargs)
    ...
    def build(self, input_shape):
        ...
        self.attention_kernel_1 = self.add_weight(shape=(input_shape[2], 1),
    ...
    def call(self, inputs, states, training=None):
        ...
        (recurrent_kernel_i, recurrent_kernel_f,
         recurrent_kernel_c, recurrent_kernel_o) = array_ops.split(self.recurrent_kernel, 4, axis=3)
        ...
        a_temp = self.attention(h_temp, attention_kernel_1, attention_kernel_2)
        h = a_temp * h_temp
    ...
    def get_config(self):
        ...
        base_config = super(AttConvLSTM2DCell, self).get_config()
        return dict(list(base_config.items()) + list(config.items()))


@keras_export('keras.layers.ConvLSTM2D')
class AttConvLSTM2D(AttConvRNN2D):
    """Convolutional LSTM.
    ...
    def __init__(self,
                 ...
                 recurrent_dropout=0.,
                 **kwargs):
        cell = AttConvLSTM2DCell(filters=filters,
        ...
        super(AttConvLSTM2D, self).__init__(cell,
    ...
    def call(self, inputs, mask=None, training=None, initial_state=None):
        ...
        return super(AttConvLSTM2D, self).call(inputs,
                                               mask=mask,
                                               training=training,
    ...
    def get_config(self):
        config = {'filters': self.filters,
                  ...
                  'dropout': self.dropout,
                  'recurrent_dropout': self.recurrent_dropout}
        base_config = super(AttConvLSTM2D, self).get_config()
